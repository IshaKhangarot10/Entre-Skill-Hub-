  ...
  return (
    <footer className="bg-[#f9f9f9] text-black font-['Inter'] text-[10px] tracking-[0.05em] font-medium w-full border-t border-[#c4c7c7]/20 flex flex-col md:flex-row justify-between items-center px-[64px] py-[12px] mt-[120px] z-10">
      ...
      <div className="flex gap-8 mb-6 md:mb-0">
        <Link href="/privacy" className="text-[#444748] hover:opacity-50 transition-opacity duration-300 uppercase">PRIVACY</Link>
        <Link href="/terms" className="text-[#444748] hover:opacity-50 transition-opacity duration-300 uppercase">TERMS</Link>
        <Link href="/contact" className="text-[#444748] hover:opacity-50 transition-opacity duration-300 uppercase">CONTACT</Link>
      </div>
      <div className="text-[#444748] opacity-50 uppercase">
        ©2024 EntreSkill. ALL RIGHTS RESERVED.
      </div>
    </footer>
  );
}
